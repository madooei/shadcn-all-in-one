...
To check for updates in your package dependencies, you can use the following command:

```bash
npx npm-check-updates
```

Then you can update your package dependencies with the following command:

```bash
npx npm-check-updates -u
```

Or, if you want to update specific packages, you can use the following command:
